      ...
      <div className="flex h-full max-h-screen flex-col gap-2">
        ...
        <div className="p-3 border-t flex flex-col gap-3">
          ...
          <div className="flex items-center justify-center border-t pt-2">
             <button onClick={() => setCollapsed(!collapsed)} className="p-1.5 hover:bg-muted text-muted-foreground rounded-md w-full flex justify-center" aria-label={collapsed ? "Expand sidebar" : "Collapse sidebar"}>
