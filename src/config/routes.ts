...
export const LOCAL_MERGE_PERSON_PATH = (id: string) => BASE_API_ENDPOINT + "/people/" + id + "/merge";
export const CREATE_PERSON_PATH = BASE_API_ENDPOINT + "/people/create";
...
export const PERSON_ASSETS_PATH = (id: string, page: number, sort?: string) => BASE_API_ENDPOINT + "/people/" + id + "/assets?page=" + page + (sort ? `&sort=${sort}` : '');
